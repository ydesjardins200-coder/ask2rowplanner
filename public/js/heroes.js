...
var HEROES=[
  {n:"Nika",f:"LO",t:"Inf"},{n:"Liliya",f:"LO",t:"Mag"},{n:"Madeline",f:"LO",t:"Inf"},
  ...
  {n:"Vardun",f:"LO",t:"Mag"},{n:"Eliana",f:"LO",t:"Inf"},{n:"Alistair",f:"LO",t:"Cav"},
  ...
  {n:"Hosk",f:"WB",t:"Inf"},{n:"Kinnara",f:"WB",t:"Mrk"},{n:"Bakshi",f:"WB",t:"Cav"},
...
// Build a <select>'s options grouped by faction. Pass typeFilter (e.g. 'Inf') to
// restrict to one unit type; when filtered, the per-hero type suffix is dropped
// since it would be redundant.
function heroOptions(sel,typeFilter){
  ...
  order.forEach(function(fk){
    var list=HEROES.filter(function(h){return h.f===fk&&(!typeFilter||h.t===typeFilter);}).sort(function(a,b){return a.n<b.n?-1:1;});
    if(!list.length)return;
    o+='<optgroup label="'+esc2(HERO_FACTIONS[fk])+'">';
    list.forEach(function(h){
      var lbl=typeFilter?h.n:(h.n+' ('+h.t+')');
      o+='<option value="'+esc2(h.n)+'"'+((sel||'')===h.n?' selected':'')+'>'+esc2(lbl)+'</option>';
    });
    o+='</optgroup>';
  });
  return o;
