...
initRoster();buildTabs();renderMap('blue');renderMap('yellow');renderPlayers();renderStaff();
STORE.load(function(d){if(d){try{assign=d.a||{};if(!rosterDirty&&d.r&&d.r.length)roster=d.r;renderMap('blue');renderMap('yellow');if(!rosterDirty)renderPlayers();renderStaff();}catch(e){}}});
