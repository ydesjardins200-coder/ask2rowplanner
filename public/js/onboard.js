...
window.showOnboarding=function(client,uid){
  ...
  var FS=[
    ...
    {k:"decoration",l:"Decoration",t:"sel",o:["1","2","3","4","5","6","7","8","9"]},
    {k:"svip",l:"SVIP",t:"chk"},
    {k:"faction",l:"Faction",t:"sel",o:["Human","OrcWilderberg","Wood Elf"]},
    {k:"title",l:"Alliance Title",t:"sel",o:["none","Chief Warden","Spymaster","King"]},
    {k:"legendary",l:"Legendary cities",t:"sel",o:["1","2","3","4","5"]},
  ...
  st.textContent='#obwrap{position:fixed;inset:0;z-index:99999;background:#0a1420;overflow:auto;font-family:Arial;color:#e8eef4}.obform{max-width:540px;margin:30px auto;padding:22px;background:#0e1c2c;border:1px solid #24425f;border-radius:14px}.obform h2{margin:0 0 4px}.obsub{color:#9fb3c6;font-size:13px;margin:0 0 16px;line-height:1.5}.obrow{display:flex;align-items:center;gap:10px;padding:7px 0;border-bottom:1px solid #14202e;font-size:13px}.obrow>label{flex:0 0 150px;color:#c9d4de}.obrow input[type=text],.obrow select{flex:1;background:#0a1622;border:1px solid #2f5680;border-radius:7px;color:#fff;padding:8px}.obchk{display:inline-flex;align-items:center;gap:5px;white-space:nowrap}.obmulti{display:flex;flex-wrap:wrap;gap:6px 12px;flex:1}.obmsg{min-height:16px;font-size:12px;margin:10px 0;color:#ff9b9b}.obgo{background:#1c86ff;border:none;color:#fff;font-weight:bold;padding:11px 18px;border-radius:9px;cursor:pointer;font-size:14px;margin-top:8px}.obout{background:#24425f;border:1px solid #3d6a96;color:#fff;padding:11px 16px;border-radius:9px;cursor:pointer}';
